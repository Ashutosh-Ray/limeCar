...
class Index extends Base {
    ...
    {            
        ...
        $vaules = array(            
         ...
         $url = "http://service.imshop.com/index.php?m=Home&c=Index&a=user_push&".http_build_query($vaules);
    ...
    public function changeTableVal(){  
            ...
            M($table)->where("$id_name = $id_value")->save(array($field=>$value,'sold_price'=>$sold_price)); // 根据条件保存修改的数据
    }	    
