...
return [
    ...
    'SEND_SCENE' => array(
        ...
        '6'=>array('身份验证','尊敬的用户，您的验证码为${code}, 本验证码有效时间为10分钟, 请勿告诉他人.','bind_mobile_sms_enable'),
    ),
    ...
    /**假设这个访问地址是 www.imshop.cn/home/goods/goodsInfo/id/1.html 
    ...
    ['mca'=>'home_Goods_ajaxComment','p'=>['goods_id','commentType','p']],  // 缓存评论静态页面 
    ['mca'=>'home_Goods_ajax_consult','p'=>['goods_id','consult_type','p']],  // 缓存咨询静态页面 
    ],    
];
